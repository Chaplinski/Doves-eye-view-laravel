...
return new class extends Migration
{
    ...
    private static function content(): string
    {
      ...
      <section class="section parallax-container breadcrumb-media-content" data-parallax-img="../../images/custom/blog/fourbouquets.jpg">
      ...
      <section class="section section-lg bg-default">
        <div class="container">
          ...
          <div class="row">
            <div class="col-12"><img src="/images/custom/blog/covid-wedding-guest-list.jpg" alt="Groom writes wedding guest list for professional marriage live streaming for wedding in Downer’s Grove, Illinois." width="1170" height="456"/>
            </div>
          </div>
          <div class="row row-50">
            <div class="col-lg-12 order-lg-2">
            ...
            <div class="col-lg-3 pr-lg-5">
              <div class="row row-50">
                <div class="col-sm-6 col-lg-12">
                    <img id="myImg" src="../../images/custom/blog/covid-wedding-invitation-idea.jpg" alt="Wedding livestream invitation idea." width="398" height="283"/>
                    <!-- The Modal -->
