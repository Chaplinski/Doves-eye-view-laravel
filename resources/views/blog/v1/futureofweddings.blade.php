@extends('layouts.app')
@section('content')
    <section class="section parallax-container breadcrumb-media-content" data-parallax-img="{{asset('assets/images/custom/blog/firework-hearts.jpg')}}">
    ...
    <section class="section section-lg bg-default">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12"><img src="{{asset('assets/images/custom/blog/covid-wedding-videography.jpg')}}" alt="Masked couple gets married during a pandemic in Chicago, Illinois" width="1170" height="456"/>
                </div>
            </div>
            <div class="row row-50">
                <div class="col-lg-12 order-lg-2">
            ...
            <div class="row row-50">
                ...
                <div class="col-lg-4 pr-lg-5">
                    <div class="row row-50">
                        <div class="col-sm-6 col-lg-12"><img src="{{asset('assets/images/custom/blog/wedding-live-stream-services.jpg')}}" alt="Livestreaming your wedding in the Chicagoland area allows all your friends and family to be included in your big day" width="398" height="581"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="blog-post-share text-lg-right">
                        <ul class="list-inline">
                            ...
                            <li><a class="icon icon-sm fa-facebook" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.doveseyeviewstreaming.com%2Fblog%2Ffutureofweddings&amp;src=sdkpreparse"></a></li>
                            <li><a class="twitter-share-button icon icon-sm fa-twitter"
                                   href="https://twitter.com/intent/tweet"
                                   data-text="Is Wedding Livestreaming Here To Stay?"
                                   data-url="https://doveseyeviewstreaming.com/blog/futureofweddings"
                            ...
                            <li><script src="https://platform.linkedin.com/in.js" type="text/javascript">lang: en_US</script>
                                <script type="IN/Share" data-url="https://www.doveseyeviewstreaming.com/blog/futureofweddings"></script></li>
                        </ul>
                    </div>
                </div>
            </div>
