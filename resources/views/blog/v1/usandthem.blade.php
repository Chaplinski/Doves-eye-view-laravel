@extends('layouts.app')
@section('content')
    <section class="section parallax-container breadcrumb-media-content" data-parallax-img="{{asset('assets/images/custom/blog/fieldsofgold.jpg')}}">
    ...
    <section class="section section-lg bg-default">
        <div class="container">
            <div class="row row-50 justify-content-lg-between">
                <div class="col-lg-6">
                    <ul class="blog-post-meta">
                        ...
                        <li><span class="icon mdi mdi-clock"></span>September 16, 2021</li>
                        <li><div class="fb-share-button" data-href="https://doveseyeviewstreaming.com/blog/usandthem" data-layout="button_count" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdoveseyeviewstreaming.com%2Fblog%2Fusandthem&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div></li>
                    </ul>
                ...
                <div class="col-lg-6 col-xl-5"><img src="{{asset('assets/images/custom/blog/bride-groom-wedding-dance.jpg')}}" alt="Bride and groom have wedding dance in field near Chicago, Illinois." width="518" height="569"/>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
            ...
            <div class="row row-50 justify-content-lg-between">
                <div class="col-lg-3"><img src="{{asset('assets/images/custom/blog/wedding-dress-zoom-videography.jpg')}}" alt="Bride and groom share their wcovid wedding ideas on their Zoom live stream wedding." width="270" height="296"/>
                </div>
                <div class="col-lg-9">
            ...
            <div class="row">
                ...
                <div class="col-lg-4"><img style="padding-top:50px;" src="{{asset('assets/images/custom/blog/chicago-illinois-wedding-videography.jpg')}}" alt="A newly married couple in Joliet, Illinois as they show you how to livestream a wedding on Facebook." width="369" height="406"/>
                ...
                <div class="col-12">
                    <div class="blog-post-share text-lg-right">
                        <ul class="list-inline">
                            ...
                            <li><a class="icon icon-sm fa-facebook" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdoveseyeviewstreaming.com%2Fblog%2Fusandthem&amp;src=sdkpreparse"></a></li>
                            <li><a class="twitter-share-button icon icon-sm fa-twitter"
                                   ...
                                   data-url="https://doveseyeviewstreaming.com/blog/usandthem"
                            ...
                            <li><script src="https://platform.linkedin.com/in.js" type="text/javascript">lang: en_US</script>
                                <script type="IN/Share" data-url="https://www.doveseyeviewstreaming.com/blog/usandthem"></script></li>
                        </ul>
                    </div>
                </div>
            </div>
