                    ...
                    <div class="blog-post-content">
                        ...
                        <div class="panel">
                            <p>A wedding livestreaming service provides you with the ability to share your wedding day with your loved ones that are unable to attend. Dove's Eye View is Chicago's best livestreaming service because we livestream your wedding ceremony in HD from 3 or more camera angles. You will immediately have a copy of your wedding that you can share with loved ones and watch over and over again.
                                ...
                                <br /><br />There’s a lot more to consider when comparing wedding videography and wedding livestreaming, so we made a blog post you can find <a href="https://www.doveseyeviewwedding.com/blog/usandthem">here</a>.</p>
                        </div>

                        <button class="accordion">I see that you livestream weddings in Chicago and the Chicago suburbs. Are you willing to travel outside of Chicagoland?</button>
                        <div class="panel">
                        ...
                        <div class="panel">
                            <p>It would be an honor to be a part of your wedding celebration and we will do our best to fit you into our schedule.</p>
                        </div>

                        <button class="accordion">Some of my guests are not tech savvy. Will it be easy for them to access my livestream?</button>
                        <div class="panel">
                            <p>One of the main reasons Dove's Eye View is the best platform to stream a wedding is because watching your marriage livestream is as easy as clicking a link and pushing play on a video player. As long as your guests can do those two things then there should be no trouble. Remote wedding guests do not need to download any sort of livestream wedding app and they do not need Facebook or any other social media account to watch your wedding livestream.
                                <br /><br />Check out a sample wedding livestream page <a href="/sample">here</a>.</p>
                        </div>

                        <button class="accordion">Do I get to keep a copy of my wedding livestream video?</button>
                        <div class="panel">
                            <p>Of course! We livestream your wedding in real time, and then afterwards we share with you a copy of your recorded wedding livestream on your own thumb drive that we provide. Your marriage livestream also stays online for 3 months, so you and your remote guests can watch your wedding video over and over.</p>
                        </div>

                        <button class="accordion">What video resolution do you livestream in?</button>
                        <div class="panel">
                            <p>We livestream weddings in 720p HD video resolution.</p>
                        </div>
                        <button class="accordion">What happens if the internet connection drops?</button>
                        <div class="panel">
                            <p>Although rare, internet connection issues do happen. If the internet drops for a short period of time then in most situations the livestream will resume when the internet does. Unfortunately, remote guests will have missed the part of the wedding livestream when the internet was down.<br /><br />However, we record every livestream to a hard drive as we are filming, and if any internet issues come up we upload a high quality video immediately after the ceremony for your guests to enjoy. Because storing a video on a hard drive does not rely on an internet connection, this video will include the parts of the livestream that remote wedding guests missed.</p>
                        </div>
                    </div>
                </div>
