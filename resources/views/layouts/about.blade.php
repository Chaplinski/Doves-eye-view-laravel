    ...
    <div class="container">
        <div class="row row-50">
            <div class="col-lg-6">
                ...
                <p>Musician and full-time software engineer, Scott likes playing euchre, doing puzzles, and going for an afternoon run. Prior to starting Dove’s Eye View he owned a live trivia company, was a camera operator at WEIU-TV, and won several awards from the National Institute of Standards and Technology for mobile app development. Scott holds a Masters of Computer Science from Illinois Institute of Technology.</p>
            </div>
